<ema:note:pandoc>
  ...
  <Header>
    <h1 class="block mt-6 mb-4 text-4xl font-bold border-b-4" />
    <h2 class="inline-block mt-6 mb-4 text-3xl font-bold border-b-2" />
    <h3 class="mt-6 mb-2 text-3xl font-bold border-b-2" />
    <h4 class="mt-6 mb-2 text-2xl font-bold border-b-2" />
    <h5 class="mt-6 mb-2 text-xl font-bold border-b-2" />
    <h6 class="mt-6 mb-2 text-xl font-bold border-b-2" />
  </Header>
