...
<bind tag="header-class">group mt-6 mb-4 font-bold font-sans</bind>
...
<ema:note:pandoc>
  ...
  <Header:2>
    <h2 id="${header:id}" class="${header-class} text-1xl note-h2">
      <heading-inlines-with-anchor />
    </h2>
  </Header:2>
  <Header:3>
    <h3 id="${header:id}" class="${header-class} text-1xl note-h3">
      <heading-inlines-with-anchor />
    </h3>
  </Header:3>
  <Header:4>
    <h4 id="${header:id}" class="${header-class} text-1xl note-h4">
      <heading-inlines-with-anchor />
    </h4>
  </Header:4>
  <Header:5>
    <h5 id="${header:id}" class="${header-class} text-1xl">
      <heading-inlines-with-anchor />
    </h5>
  </Header:5>
  <Header:6>
