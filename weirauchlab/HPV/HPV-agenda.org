...
** TODO RNA-seq
- [X] Find DEGs relative to control by celltype (Flp vs TREX), then
...
** HOMER de novo motif enrichment analysis on the E2 ChIP-seq peaks
- Known consensus is ACCGNNCGGT and ACCGNNNNCGGT


* Preparing the data and QC
Data freeze of all samples should be done before analysis begins

** DONE ask Andrew anatomy about the RNA-seq differential analysis pipeline outputs
CLOSED: [2026-04-14 Tue 09:31]
...
* DONE Find resources for HPV
CLOSED: [2026-04-14 Tue 09:31] DEADLINE: <2026-02-25 Wed>
